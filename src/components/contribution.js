...
export default function Recent() {
  return (
      <div className='mt-20 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-6 lg:mt-5 lg:mb-5 lg:px-8 xl:mt-18 xl:mb-18'>
          <div className='relative  flex'>
              ...
              <p className='text-white font-small  font-small py-1.5 '>VIEW MORE</p>
          </div><br></br>
           ...
           <div className=' md:grid grid-cols-2 gap-4 w-full'>
               ...
               <div className='mt-4 text-left md:text-center md:justify-center'>
                   <h2 className='font-Cinzel mb-15 text-3xl tracking-tight  sm:text-4xl uppercase md:text-6xl font-strong  text-transparent bg-clip-text bg-gradient-to-r from-gold-1 via-gold-2 to-gold-3 xl:inline'>3D Greek Statue Pack</h2>
                   <h3 className='text-white mb-5 mt-5 font-light uppercase sm:text-5xl md:text-3xl'>Over 200 Greek style sculpture</h3>
