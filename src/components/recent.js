...
export default function Recent() {
  return (
      <div className='mt-20 mb-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-6 lg:mt-5 lg:px-8 xl:mt-18 xl:mb-24'>
              ...
              <p className='text-white font-small py-1.5'>VIEW MORE</p>
